...
public sealed class AppSettings
{
    ...
    public OscToolbarItems OscButtons { get; set; } = OscToolbarItems.Speed | OscToolbarItems.Settings | OscToolbarItems.Playlist | OscToolbarItems.MiniPlayer | OscToolbarItems.Fullscreen;
